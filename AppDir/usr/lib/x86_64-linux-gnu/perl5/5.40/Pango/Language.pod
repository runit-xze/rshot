...
=item * 'bassa-vah' / 'PANGO_SCRIPT_BASSA_VAH'

=item * 'caucasian-albanian' / 'PANGO_SCRIPT_CAUCASIAN_ALBANIAN'

=item * 'duployan' / 'PANGO_SCRIPT_DUPLOYAN'

=item * 'elbasan' / 'PANGO_SCRIPT_ELBASAN'

=item * 'grantha' / 'PANGO_SCRIPT_GRANTHA'

=item * 'khojki' / 'PANGO_SCRIPT_KHOJKI'

=item * 'khudawadi' / 'PANGO_SCRIPT_KHUDAWADI'

=item * 'linear-a' / 'PANGO_SCRIPT_LINEAR_A'

=item * 'mahajani' / 'PANGO_SCRIPT_MAHAJANI'

=item * 'manichaean' / 'PANGO_SCRIPT_MANICHAEAN'

=item * 'mende-kikakui' / 'PANGO_SCRIPT_MENDE_KIKAKUI'

=item * 'modi' / 'PANGO_SCRIPT_MODI'

=item * 'mro' / 'PANGO_SCRIPT_MRO'

=item * 'nabataean' / 'PANGO_SCRIPT_NABATAEAN'

=item * 'old-north-arabian' / 'PANGO_SCRIPT_OLD_NORTH_ARABIAN'

=item * 'old-permic' / 'PANGO_SCRIPT_OLD_PERMIC'

=item * 'pahawh-hmong' / 'PANGO_SCRIPT_PAHAWH_HMONG'

=item * 'palmyrene' / 'PANGO_SCRIPT_PALMYRENE'

=item * 'pau-cin-hau' / 'PANGO_SCRIPT_PAU_CIN_HAU'

=item * 'psalter-pahlavi' / 'PANGO_SCRIPT_PSALTER_PAHLAVI'

=item * 'siddham' / 'PANGO_SCRIPT_SIDDHAM'

=item * 'tirhuta' / 'PANGO_SCRIPT_TIRHUTA'

=item * 'warang-citi' / 'PANGO_SCRIPT_WARANG_CITI'

=item * 'ahom' / 'PANGO_SCRIPT_AHOM'

=item * 'anatolian-hieroglyphs' / 'PANGO_SCRIPT_ANATOLIAN_HIEROGLYPHS'

=item * 'hatran' / 'PANGO_SCRIPT_HATRAN'

=item * 'multani' / 'PANGO_SCRIPT_MULTANI'

=item * 'old-hungarian' / 'PANGO_SCRIPT_OLD_HUNGARIAN'

=item * 'signwriting' / 'PANGO_SCRIPT_SIGNWRITING'
