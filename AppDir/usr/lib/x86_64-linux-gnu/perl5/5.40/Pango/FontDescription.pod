...
=item * 'variations' / 'PANGO_FONT_MASK_VARIATIONS'
...
=item * 'all-small-caps' / 'PANGO_VARIANT_ALL_SMALL_CAPS'

=item * 'petite-caps' / 'PANGO_VARIANT_PETITE_CAPS'

=item * 'all-petite-caps' / 'PANGO_VARIANT_ALL_PETITE_CAPS'

=item * 'unicase' / 'PANGO_VARIANT_UNICASE'

=item * 'title-caps' / 'PANGO_VARIANT_TITLE_CAPS'
