...
=item * 'allow-breaks' / 'PANGO_ATTR_ALLOW_BREAKS'

=item * 'show' / 'PANGO_ATTR_SHOW'

=item * 'insert-hyphens' / 'PANGO_ATTR_INSERT_HYPHENS'

=item * 'overline' / 'PANGO_ATTR_OVERLINE'

=item * 'overline-color' / 'PANGO_ATTR_OVERLINE_COLOR'

=item * 'line-height' / 'PANGO_ATTR_LINE_HEIGHT'

=item * 'absolute-line-height' / 'PANGO_ATTR_ABSOLUTE_LINE_HEIGHT'

=item * 'text-transform' / 'PANGO_ATTR_TEXT_TRANSFORM'

=item * 'word' / 'PANGO_ATTR_WORD'

=item * 'sentence' / 'PANGO_ATTR_SENTENCE'

=item * 'baseline-shift' / 'PANGO_ATTR_BASELINE_SHIFT'

=item * 'font-scale' / 'PANGO_ATTR_FONT_SCALE'
