...
- [x] Decompose `Shutter::Screenshot::Window` (the largest remaining monolith at ~1000 lines)
  - [x] Extract `Window::Highlighter` role (selection overlay UI)
- [x] Implement Asynchronous Capture Pipeline (non-blocking delays and captures)
