...
{ package MockGettextIO; sub get { $_[1] } }
{ package MockSC; sub get_rusf { undef } sub set_rusf { 1 } sub get_root { '/tmp' } }
{ package MockSHF; sub utf8_decode { $_[1] } sub nsort { sort @_ } sub file_exists { 0 } }
{ package MockDialogs; sub dlg_warning_message { 40 } }
{ package MockPixbufLoader; sub load { 1 } }
{ package MockCanvasRectIO; sub set { 1 } sub get { 100 } sub get_bounds { 1 } }
{ package MockCanvas; sub render { 1 } }
{ package MockSurface; sub write_to_png_stream { my ($self, $cb) = @_; $cb->(undef, 'mockdata'); 1 } }
{ package MockLoader; sub write { 1 } sub close { 1 } sub get_pixbuf { 'mock_pixbuf' } }

{ package Shutter::App::Directories; sub get_home_dir { '/tmp' } }
{ package Shutter::App::HelperFunctions; sub new { bless {}, shift } sub folder_exists { 1 } sub file_exists { 0 } }
{ package Shutter::Pixbuf::Save; sub new { bless {}, shift } sub save_pixbuf_to_file { 1 } }
