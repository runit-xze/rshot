...
subtest "_assemble() behaviour" => sub {
    ...
    # Instead, mock _assemble at the Moo method level to capture what it would do.
    {
        ...
        is($captured_delay, 10,
           "Delay computed as 100/fps = 10 (for ImageMagick -delay)");
        like($captured_frames_str, qr/frame_00000.*frame_00001/,
             "Frames string contains both frame paths");
        is($done_value, '/tmp/test_output.gif',
           "on_done called with output path on success");
