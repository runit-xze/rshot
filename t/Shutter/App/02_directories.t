...

{
	...
	subtest "get_root_dir" => sub {
		...
		subtest "invoke create_if_not_exists" => invoke_create_if_not_exists->($expected_dir, \&Shutter::App::Directories::get_root_dir);

		is(Shutter::App::Directories::get_root_dir(), $expected_dir, "root dir");
	};

	subtest "get_cache_dir" => sub {
		my $expected_dir = Glib::get_user_cache_dir . "/" . Shutter::App::Directories->SHUTTER_DIR . "/" . Shutter::App::Directories->UNSAVED_DIR;

		subtest "invoke create_if_not_exists" => invoke_create_if_not_exists->($expected_dir, \&Shutter::App::Directories::get_cache_dir);

		is(Shutter::App::Directories::get_cache_dir(), $expected_dir, "cache dir");
	};

	subtest "get_temp_dir" => sub {
		my $expected_dir = Glib::get_user_cache_dir . "/" . Shutter::App::Directories->SHUTTER_DIR . "/" . Shutter::App::Directories->TEMP_DIR;

		subtest "invoke create_if_not_exists" => invoke_create_if_not_exists->($expected_dir, \&Shutter::App::Directories::get_temp_dir);
	...
	subtest "get_autostart_dir" => sub {
		...
		subtest "invoke create_if_not_exists" => invoke_create_if_not_exists->($expected_dir, \&Shutter::App::Directories::get_autostart_dir);
