...
sub setup_right_vbox_c ($self) {
	...
	my $value_callback = sub {
		$app->{_selector}
			->set_selection({x => $app->{_x_spin_w}->get_value, y => $app->{_y_spin_w}->get_value, width => $app->{_width_spin_w}->get_value, height => $app->{_height_spin_w}->get_value});
	};
	...
	$app->{_x_spin_w_handler} = $app->{_x_spin_w}->signal_connect('value-changed' => $value_callback);
	...
	$app->{_y_spin_w_handler} = $app->{_y_spin_w}->signal_connect('value-changed' => $value_callback);
	...
	$app->{_width_spin_w_handler} = $app->{_width_spin_w}->signal_connect('value-changed' => $value_callback);
	...
	$app->{_height_spin_w_handler} = $app->{_height_spin_w}->signal_connect('value-changed' => $value_callback);
