			...
			if ($item_hash->{mirrored_w} < 0 && $item_hash->{mirrored_h} < 0) {
				$item_hash->{line}->set(
					'points' => Shutter::Draw::Utils::points_to_canvas_points(
							$item_hash->get('x') + $item_hash->get('width'), $item_hash->get('y') + $item_hash->get('height'),
							$item_hash->get('x'),                                        $item_hash->get('y')
					),
					'visibility' => $visibility
				);
				...
				$item_hash->{line}->set(
					'points' => Shutter::Draw::Utils::points_to_canvas_points(
							$item_hash->get('x') + $item_hash->get('width'), $item_hash->get('y'),
							$item_hash->get('x'),                                        $item_hash->get('y') + $item_hash->get('height')
					),
					'visibility' => $visibility
				);
