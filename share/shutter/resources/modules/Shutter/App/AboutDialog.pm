...
sub show ($self) {
	...
	my $offset = 400;
	my $timer  = Glib::Timeout->add(30, sub {
		$offset -= 1.5;
	...
	my $logo_surface;
	eval {
		$logo_surface = Cairo::ImageSurface->create_from_png('/home/ashley/.gemini/antigravity-cli/brain/422b5aec-b8a4-4114-9ace-5e53b45146a1/rshot_logo_transparent.png');
	};
